...
\textit{23.}
设\(V_1,\cdots,V_m\)是内积空间.证明：\(V_1 \times \cdots \times V_m\)上一个合法的内积定义是
    \begin{align*}
...
\(v=(v_1,\cdots,v_m) \in V_1 \times \cdots \times V_m\).
    \begin{align*}
    ...
    \end{align*}
共轭对称性：设\(u=(u_1,\cdots,u_m),v=(v_1,\cdots,v_m) \in V_1 \times \cdots \times V_m\)，

从而\(\overline{u}=(\overline{u_1},\cdots,\overline{u_m}),\overline{v}=(\overline{v_1},\cdots,\overline{v_m})\).
    \begin{align*}
